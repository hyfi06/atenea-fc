...
- Sin paginación, alta de asesor solo por admin, y los límites de uso/cierre automático/recordatorios ya diferidos por la ADR 0016 quedan todos registrados en [`docs/technical-debt.md`](../technical-debt.md) como un único lugar buscable, en vez de dispersos entre ADRs.
